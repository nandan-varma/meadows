...
private:
    ...
    llvm::Value* createPrintfCall(const std::string& format, const std::vector<llvm::Value*>& args = {});
...
public:
    ...
    // Generate executable
    bool generateExecutable(const std::string& objectFile, const std::string& executableFile);

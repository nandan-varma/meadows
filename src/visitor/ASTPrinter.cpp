...
void ASTPrinter::visit(BinaryExpression& node) {
    ...
    switch (node.operator_) {
        ...
        case BinaryOp::MODULO: opStr = "%"; break;
        case BinaryOp::POWER: opStr = "**"; break;
        case BinaryOp::EQUAL: opStr = "=="; break;
        case BinaryOp::NOT_EQUAL: opStr = "!="; break;
        case BinaryOp::LESS_THAN: opStr = "<"; break;
        case BinaryOp::LESS_EQUAL: opStr = "<="; break;
        case BinaryOp::GREATER_THAN: opStr = ">"; break;
...
void ASTPrinter::visit(PassStatement& node) {
    println("PassStatement");
}

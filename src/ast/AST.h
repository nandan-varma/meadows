...
public:
    ...
    ObjectExpr(std::unordered_map<std::string, std::unique_ptr<Expr>> p) : pairs(std::move(p)) {}
    void accept(ExprVisitor& visitor) override;
};
...
public:
    ...
    LetStmt(const std::string& n, std::unique_ptr<Expr> i) : name(n), initializer(std::move(i)) {}
    void accept(StmtVisitor& visitor) override;
};
...
public:
    ...
    FuncStmt(const std::string& n, std::vector<std::string> p, std::vector<std::unique_ptr<Stmt>> b)
...
public:
    ...
    IfStmt(std::unique_ptr<Expr> c, std::vector<std::unique_ptr<Stmt>> t, std::vector<std::unique_ptr<Stmt>> e)
...
public:
    ...
    std::vector<std::unique_ptr<Stmt>> body;
    ForStmt(const std::string& v, std::unique_ptr<Expr> s, std::unique_ptr<Expr> e, std::vector<std::unique_ptr<Stmt>> b)
        : var(v), rangeStart(std::move(s)), rangeEnd(std::move(e)), body(std::move(b)) {}
    void accept(StmtVisitor& visitor) override;
};

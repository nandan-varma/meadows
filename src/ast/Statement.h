...
public:
  ...
  ClassDefinition(const std::string &name,
                  ...
                  std::unique_ptr<Statement> body,
                  const SourceLocation &location)
      : Statement(location), name(name), bases(std::move(bases)),
        body(std::move(body)) {}
...
public:
  ...
  std::vector<std::string>
      aliases; // same size as modules, empty string means no alias

  ImportStatement(std::vector<std::string> modules,
                  std::vector<std::string> aliases,
                  const SourceLocation &location)
      : Statement(location), modules(std::move(modules)),

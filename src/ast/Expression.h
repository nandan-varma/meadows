...
public:
    ...
    BinaryExpression(std::unique_ptr<Expression> left, BinaryOp op, 
        ...
        : Expression(location), left(std::move(left)), operator_(op), right(std::move(right)) {}
...
public:
    ...
    UnaryExpression(UnaryOp op, std::unique_ptr<Expression> operand, const SourceLocation& location)
...
public:
    ...
    FunctionCall(std::unique_ptr<Expression> function, 
        ...
        : Expression(location), function(std::move(function)), arguments(std::move(arguments)) {}
...
public:
    ...
    AttributeAccess(std::unique_ptr<Expression> object, const std::string& attribute, 
                   const SourceLocation& location)
...
public:
    ...
    IndexAccess(std::unique_ptr<Expression> object, std::unique_ptr<Expression> index,
               const SourceLocation& location)
...
public:
    ...
    Assignment(std::unique_ptr<Expression> target, std::unique_ptr<Expression> value,
              const SourceLocation& location)
        : Expression(location), target(std::move(target)), value(std::move(value)) {}
